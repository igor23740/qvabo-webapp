...
const modelConfigs = {
    ...
    'gpt-image-25': {
        ...
        // Витрина: боевой кадр владельца 09.09 (exec 122385, high, 2048×1152 → 1280 webp): постер «Визит в Алжир», кириллица и латиница
        // в коллаже без ошибок. Исходник — docs/assets/gpt-image-25/QVABO_122385_source.png.
        showcase: { logo: 'openai.png?v=1', logoTint: '#10a37f', image: 'gpt-image-25-preview.webp?v=20260909', sub: 'Пример: постер-коллаж с кириллицей, GPT Image 2.5 Sunburst (high)' },
        maxFiles: 10,
